...
#else
typedef unsigned long   j1939_uint32_t;  /** < 32位无符号整形*/
typedef long   		    j1939_int32_t;   /** < 32位整形*/
typedef unsigned int    j1939_uint16_t;  /** < 16位无符号整形*/
typedef unsigned int    j1939_uint8_t;   /** < 8位无符号整形*/
typedef int             j1939_int8_t;    /** < 8位无符号整形*/
#endif
...
#if TI_DSP
#define J1939_MSG_LENGTH	6  //消息长度
#else
#define J1939_MSG_LENGTH    18  //消息长度
#endif
...
*
*/
    j1939_uint32_t CanId;
	struct   j1939_PID
	{ 
	    j1939_uint32_t   SourceAddress      : 8;   /**< SA*/
	    j1939_uint32_t   PDUSpecific        : 8;   /**< PS*/
	    j1939_uint32_t   PDUFormat          : 8;   /**< PF*/
	    j1939_uint32_t   DataPage           : 1;  /**< 数据页*/
	    j1939_uint32_t   Res                : 1;  /**< Res位*/
	    j1939_uint32_t   Priority           : 3;  /**< 优先级*/
	    j1939_uint32_t   Reserve            : 3;  /**< 空闲*/
		j1939_uint8_t	DataLength 			: 4;  /**< 数据长度*/
		j1939_uint8_t	RTR					: 4;  /**< RTR位*/
		j1939_uint8_t   Reserve1            : 8;  /**< 空闲*/
